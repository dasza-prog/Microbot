...
@ConfigGroup("autoRuneEssenceMining")
public interface AutoRuneEssenceMiningConfig extends Config
{
    @ConfigItem(
            keyName = "Altar",
            name = "Altar",
    ...
    default String GUIDE() {
        return         "<h2 style='color: #05e1f5;'>ChillX's Auto Runecrafter</h2> <br />" +
